                ...
                <div class="partner_right">
                    <div class="partner_right_main">
                        ...
                        <div class="partner_list">
                            <div class="each_mes">
                                <p>电话*</p>
                                <div :class="{active:focus=='tel'}"><input type="number" @focus="changeFocus('tel')"
                            ...
                            <div class="each_mes">
                                ...
                                <div :class="{active:focus=='add'}" style="position:relative;" @click="getProvince(0)">
                                    ...
                                    <div class="chooseAddress" v-if="showAddress">
                                        <p v-for="item in provinceList" @click.stop="getMessage(item.id,item.name)">
                                            {{item.name}}</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="partner_list">
                            <div class="leave_message">
                                <p>详细地址*</p>
                                <div :class="{active:focus=='detail'}"><input type="text" @focus="changeFocus('detail')"
                                                                              @blur="detailblur" v-model="detail"><img
                                        src="/static/images/sure.png" v-if="confirmDetail" alt=""></div>
                            </div>
                        </div>
    ...
    methods: {
      ...
      send () {
        ...
        if (!this.$storage.session.get('token')) {
          ...
          this.$router.push('/Mine/Login?probation=1')
          return false
        }
...
<style scoped>
    ...
    .each_mes div.chooseAddress::-webkit-scrollbar {
        width: 0px
    }
